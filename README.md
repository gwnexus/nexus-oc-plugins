...
| **Headroom Intercept** | [`300-headroom-intercept`](./300-headroom-intercept) | v0.5.0 | Pre-injection context compression for Nexus MCP tool outputs via `tool.execute.after` hook |
